(() => {
    ...
    (() => {
        ...
        function showPopup(form, isSucsess, response = "") {
            setTimeout((() => {
                if (flsModules.popup) {
                    const popup = form.dataset.popupMessage, popupTitle = document.querySelector("[data-popap-title]"), popupText = document.querySelector("[data-popap-text]");
                    if (isSucsess) {
                        popupTitle.innerHTML = "Success";
                        popupText.innerHTML = "Email will be sent after 3-5 minutes";
                    } else {
                        popupTitle.innerHTML = `Error ${response.status}. Form not submitted`;
        ...
        function initSliders() {
            ...
            if (document.querySelector(".role-slider")) new core(".role-slider", {
                modules: [ Navigation, EffectFade ],
                spaceBetween: 0,
                speed: 600,
                effect: "fade",
                navigation: {
                    prevEl: ".role-slider .swiper-button-prev",
                    nextEl: ".role-slider .swiper-button-next"
                }
            });
        }
